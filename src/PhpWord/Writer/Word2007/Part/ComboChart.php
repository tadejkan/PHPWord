...
use PhpOffice\PhpWord\Element\ComboChart as ComboChartElement;
 ...
 */
class ComboChart extends AbstractPart
{
    /**
     * ComboChart element.
     *
     * @var \PhpOffice\PhpWord\Element\ComboChart
     */
    private $element;
    ...
    private $types = [
        ...
        'line' => ['type' => 'line', 'colors' => 1, 'axes' => true],
     ...
     * Set chart element.
     */
    public function setElement(ComboChartElement $element): void
    {
    ...
    private function writePlotArea(XMLWriter $xmlWriter): void
    {
        ...
        foreach ($types as $type_idx => $type) {
            ...
            // Series
            $this->writeSeries($xmlWriter, $this->element->getSeries()[$type_idx], $start_idx, isset($this->options['scatter']));
            $start_idx += sizeof($this->element->getSeries()[$type_idx]);
     ...
     * @param bool $scatter
     */
    private function writeSeries(XMLWriter $xmlWriter, $series, $start_idx, $scatter = false): void
    {
        $style = $this->element->getStyle();
